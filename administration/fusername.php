...
//------------------------------------------------------------------------------
// Cricket Forgot Username Administration v4.0
//
...
function show_email_form($db)
 {
	...
	echo "<h1>Username Reminder</h1>\n";
	
	echo "<p>Please enter your email address to retrieve your username.</p>\n";

	echo "<form action=\"fusername.php\" method=\"post\">\n";
	echo "<input type=\"hidden\" name=\"mode\" value=\"senduser\" />\n";
	...
	echo "		<tr class=\"admintrrow1\">\n";
	echo "			<td>&nbsp;</td>\n";
	echo "			<td><input class=\"button\" type=\"submit\" value=\"retrieve username\"></td>\n";
	echo "		</tr>\n";
	echo "		</table>\n";					
	echo "		</form>\n";					
	echo "		</td>\n";
...
function send_email($db)
 {
	...
	echo "<h1>Username Sent!</h1>\n";
	echo "<div class=\"msg-ok\">Please check your email to retrieve your username. <a href=\"main.php\">Login again</a>?</div>\n";


	mail("
		$emailaddy" , 
		"Username Request" , 
		"Username Request\n\nSomebody requested the username to the $mysitt Administration Panel for the following account: $emailaddress\n\n
		The username is: $usern\n\nIf you did not request this username do not fear, we only email the account holder the username and never share with anybody else.\n\n
		Kind Regards,\n$mysitt","From: $mywebm\n"
	);

	} else {
	
	echo "<h1>Username Error!</h1>\n";
...
case "forgotuser":
	...
	break;
case "senduser":
	send_email($db,$_POST['emailaddress']);
	break;
default:
	show_email_form($db);
	break;
